...
class SecondCategoryEthinc extends StatefulWidget {
  final Product product;
  final String product1;
  SecondCategoryEthinc({this.product1, this.product});
  @override
  _SecondCategoryEthincState createState() => _SecondCategoryEthincState();
}

class _SecondCategoryEthincState extends State<SecondCategoryEthinc> {
  Product product;
