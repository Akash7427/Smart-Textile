...
class SecondCategoryKurti extends StatefulWidget {
  final Product product;
  final String product1;
  SecondCategoryKurti({this.product1, this.product});
  @override
  _SecondCategoryKurtiState createState() => _SecondCategoryKurtiState();
}

class _SecondCategoryKurtiState extends State<SecondCategoryKurti> {
  Product product;
  @override
  void initState() {
                        ...
                        child: Row(
                          children: <Widget>[
                            Radio(
                              ...
                              groupValue: _value4,
                              onChanged: (int value) {
                                _setvalue4(value, "Rollup Sleeves");
                              },
                              activeColor: Color(0xff66CCCC),
                            ),
                            Text(
