...
class RetailerOrderDtls extends StatefulWidget {
  final ProviderUser providerUser;

  const RetailerOrderDtls({Key key, this.providerUser}) : super(key: key);
  @override
  _RetailerOrderDtlsState createState() => _RetailerOrderDtlsState();
}

class _RetailerOrderDtlsState extends State<RetailerOrderDtls> {
              ...
              child: Row(
                ...
                children: <Widget>[
                  IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => RHomePage(),));
                    },
                  ),
                  Spacer(
                    flex: 3,
